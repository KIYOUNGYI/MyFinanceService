...
public class CommonHttpClient {
  ...
  public CompletableFuture<HttpResponse<String>> sendPutRequest(String url, String body) {
    HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create(url))
  ...
  public CompletableFuture<HttpResponse<String>> sendDeleteRequest(String url) {
    HttpRequest request = HttpRequest.newBuilder()
        .uri(URI.create(url))
        .DELETE()
        .build();
